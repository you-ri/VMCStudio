/**
 * Reference: https://github.com/duo-inc/EasyMotionRecorder/blob/master/EasyMotionRecorder/Assets/EasyMotionRecorder/Scripts/HumanoidPoses.cs
 */
...
namespace VMCStudio
{
    ...
    public class HumanoidPoses : ScriptableObject
    {
        ...
        public void ExportHumanoidAnim(string path = null)
        {
            var clip = new AnimationClip { frameRate = 30 };
            ...
            if (string.IsNullOrEmpty(path)) {
                path = string.Format ("Assets/Resources/RecordMotion_{0:yyyy_MM_dd_HH_mm_ss}_Humanoid.anim", DateTime.Now);
            }
            var uniqueAssetPath = AssetDatabase.GenerateUniqueAssetPath(path);

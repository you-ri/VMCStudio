...
namespace VMCStudio
{
    ...
    public class Calibrator
    {
        /// <summary>
        /// キャリブレーション
        /// アクターの体型に合わせてダミーを変形する
        /// </summary>
        /// <param name="realTrackerRoot"></param>
        /// <param name="handTrackerRoot"></param>
        /// <param name="headTrackerRoot"></param>
        /// <param name="footTrackerRoot"></param>
        /// <param name="ik"></param>
        /// <param name="settings"></param>
        /// <param name="leftHandOffset"></param>
        /// <param name="rightHandOffset"></param>
        /// <param name="pelvisOffset"></param>
        /// <param name="hmdTransform"></param>
        /// <param name="pelvisTransform"></param>
        /// <param name="leftHandTransform"></param>
        /// <param name="rightHandTransform"></param>
        /// <param name="leftFootTransform"></param>
        /// <param name="rightFootTransform"></param>
        /// <param name="leftElbowTransform"></param>
        /// <param name="rightElbowTransform"></param>
        /// <param name="leftKneeTransform"></param>
        /// <param name="rightKneeTransform"></param>
        /// <returns></returns>
        public static IEnumerator Calibrate (
             Transform realTrackerRoot, Transform handTrackerRoot, Transform headTrackerRoot, Transform footTrackerRoot,
             VRIK ik, Settings settings, Vector3 leftHandOffset, Vector3 rightHandOffset, float pelvisOffset,
             Transform hmdTransform, Transform pelvisTransform = null,
             Transform leftHandTransform = null, Transform rightHandTransform = null,
             Transform leftFootTransform = null, Transform rightFootTransform = null,
             Transform leftElbowTransform = null, Transform rightElbowTransform = null,
             Transform leftKneeTransform = null, Transform rightKneeTransform = null)
        {
            // 無効なトラッカーをクリア
            hmdTransform = hmdTransform != null && !hmdTransform.gameObject.activeInHierarchy ? null : hmdTransform;
            pelvisTransform = pelvisTransform != null && !pelvisTransform.gameObject.activeInHierarchy ? null : pelvisTransform;
            leftHandTransform = leftHandTransform != null && !leftHandTransform.gameObject.activeInHierarchy ? null : leftHandTransform;
            rightHandTransform = rightHandTransform != null && !rightHandTransform.gameObject.activeInHierarchy ? null : rightHandTransform;
            leftFootTransform = leftFootTransform != null && !leftFootTransform.gameObject.activeInHierarchy ? null : leftFootTransform;
            rightFootTransform = rightFootTransform != null && !rightFootTransform.gameObject.activeInHierarchy ? null : rightFootTransform;
            leftElbowTransform = leftElbowTransform != null && !leftElbowTransform.gameObject.activeInHierarchy ? null : leftElbowTransform;
            rightElbowTransform = rightElbowTransform != null && !rightElbowTransform.gameObject.activeInHierarchy ? null : rightElbowTransform;
            leftKneeTransform = leftKneeTransform != null && !leftKneeTransform.gameObject.activeInHierarchy ? null : leftKneeTransform;
            rightKneeTransform = rightKneeTransform != null && !rightKneeTransform.gameObject.activeInHierarchy ? null : rightKneeTransform;
            ...
            ik.gameObject.transform.localScale = Vector3.one;
            handTrackerRoot.localScale = Vector3.one;
            headTrackerRoot.localScale = Vector3.one;
            footTrackerRoot.localScale = Vector3.one;
            ...
            ik.gameObject.transform.localScale = new Vector3 (1 / hscale, 1 / hscale, 1 / hscale);
            ...
            hmdAdjusterTransform.position = ik.references.head.position;
            ...
            if (pelvisTransform != null) {
                ...
                pelvisAdjusterTransform.position = ik.references.pelvis.position + Vector3.down * pelvisOffset;
            ...
            ik.solver.locomotion.weight = leftFootTransform == null && rightFootTransform == null ? 1f : 0f;
        }
        ...
        /// <param name="rightKneeTransform"></param>
        /// <returns></returns>
        public static IEnumerator CalibrateScaled (
             Transform realTrackerRoot, Transform handTrackerRoot, Transform headTrackerRoot, Transform footTrackerRoot,
             VRIK ik, Settings settings, Vector3 leftHandOffset, Vector3 rightHandOffset, float pelvisOffset,
             Transform hmdTransform, Transform pelvisTransform = null,
             Transform leftHandTransform = null, Transform rightHandTransform = null,
        ...
        public static void Calibrate (VRIK ik, Settings settings, Vector3 LeftHandOffset, Vector3 RightHandOffset, Transform HMDTransform, Transform PelvisTransform = null, Transform LeftHandTransform = null, Transform RightHandTransform = null, Transform LeftFootTransform = null, Transform RightFootTransform = null)
        {
            if (!ik.solver.initiated) {
                Debug.LogError ("Can not calibrate before VRIK has initiated.");
                return;
            ...
            //両手のxをマイナス方向が正面なので体を回転させる
            var hmdForwardAngle = leftWrist.rotation * new Vector3 (-1, 0, 0);
